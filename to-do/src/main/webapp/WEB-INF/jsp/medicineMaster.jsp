		...
		<form action="/savedrug" method="post" onreadystatechange="selectItemByValue()">
			...
			<table>
				<tr>
					...
					<td><b><br>${drugobj.drugid}<br></b></td>
				...
				<tr>
					<div class="form-group">
					<td>Drug Name</td>
					<td><input style="width: 278px;"></input></td>
				...
				<tr>
						<td> Manufaturer Name</td>
						<td style="width: 300px; height: 36px; "><input style="width: 278px;"></input></td>
...
<%-- 						<input type="hidden" class="form-control" name="name" value="${sessionScope.username}"/> 
 --%>						</div>				 
		      ...
		      <b><label >Age : ${orderobj.age}</label></b>
 		      <input type="text" type="text" class="form-control"  placeholder="Age" name="age" value="${orderobj.age}">
 		    </div>
		     <div class="form-group">
		      <label >Date : ${orderobj.date}</label>
 		      <input type="text" type="text" class="form-control"  placeholder="Date" name="date" value="${orderobj.date}">
 		    </div>
		     <div class="form-group">
